...
save_model_name = 'd2v_del_dbow_clean.model'
saved_path = path + "/d2v_del_dbow_clean.bin"
...
def recom_music(lyrics, train_corpus):
    ...
    inferred_docvec = model.docvecs[doc_id]
...
if __name__ == '__main__':
    lyrics = pd.read_csv(path + '/trainSet3_deleted.csv')
